...
#if TARGET_CPU_ARM
    asm("movw %0, :lower16:(L_OBJC_CLASS_UIRefreshControl)" : "=r"(UIRefreshControlClassRef));
    asm("movt %0, :upper16:(L_OBJC_CLASS_UIRefreshControl)" : "=r"(UIRefreshControlClassRef));
#else
